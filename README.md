[README (1).md](https://github.com/user-attachments/files/28418606/README.1.md)
...
Each track ends with a capstone checkpoint (outside the numbered 26 phases) that must be completed before moving on:
...
- Capstone 04 - Deep Investigation (after Phase 22)
- Capstone 05 - Cloud SOC and Microsoft Security (after Phase 24)
- Capstone 06 - L2 Automation (after Phase 25)
- Capstone 07 - Final Job-Readiness (after Phase 26)
